...
class Proyecto4ApplicationTests(@Autowired val mockMvc: MockMvc) {
    ...
    fun `returns the existing movies`() {
        ...
        mockMvc.perform(get("/movies"))
            ...
            .andExpect(jsonPath("$[*]", hasSize<Int>(8)))
